...
function styleInfomj(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: getColormj(feature.properties.mag),
      color: "#000000",
      radius: getRadiusmj(feature.properties.mag),
      stroke: true,
      weight: 0.5
    };
  }
...
// 6. Use the function that determines the radius of the earthquake marker based on its magnitude.
  function getRadiusmj(magnitude) {
    if (magnitude === 0) {
      return 1;
    }
...
L.geoJson(data, {
    ...
    style : styleInfomj,
    onEachFeature: function(feature, layer) {
        layer.bindPopup("<h3>Magnitude" + feature.properties.mag + "</h3><hr><h4> Location:" + feature.properties.place);
    }
})
...
majorEarthquakes.addTo(map);
  ...
  let tecData = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
